...
const config = {
    ...
    info: {
        website: 'https://panzzstore.web.id'
    },

    owner: {
        name: 'Panzz',                    // Nama owner
        number: ['6289519228000']         // Format: 628xxx (tanpa + atau 0)
    },

    session: {
        pairingNumber: '6289519228000',   // Nomor WA yang akan di-pair
        usePairingCode: true              // true = Pairing Code, false = QR Code
    },

    bot: {
        name: 'PANZZBOT',                 // Nama bot
        version: '1.0.0',                 // Versi bot
        developer: 'PANZZ'          // Nama developer
    },
    ...
    store: {
        payment: [
            { name: 'Dana', number: '6289519228000', holder: 'AHM** NU* IRF** MAUL***' },
            { name: 'OVO', number: '6289699892999', holder: 'AHM** NU* IRF** MAUL***' },
            { name: 'GoPay', number: '6289699892999', holder: 'AHM** NU* IRF** MAUL***' },
            { name: 'ShopeePay', number: '6289699892999', holder: 'AHM** NU* IRF** MAUL***' }
        ],
    ...
    donasi: {
        payment: [
            { name: 'Dana', number: '089519228000', holder: 'AHM** NU* IRF** MAUL***' },
            { name: 'GoPay', number: '089699892999', holder: 'AHM** NU* IRF** MAUL***' },
    ...
    //  APIkey
    APIkey: {
        lolhuman: 'APIKey-Milik-Bot-PanzzMD(Zann,HyuuSATANN,Keisya,Danzz)', // kalau limit habis bisa beli apikey di https://api.lolhuman.xyz/pricing
        neoxr: 'Milik-Bot-PanzzMD',  // kalau limit habis bisa beli apikey di https://api.neoxr.eu/pricing
